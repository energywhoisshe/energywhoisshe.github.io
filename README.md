...
> `3 Households, arthouse game on computer, controller, and projector, playtime about 15'00", 2021.11 - 이 글은 작업이 공간에 설치되기 약 1~2달 전에 쓰여집니다. PC 기기에 최적화된 아티클로, 스크롤을 상하좌우로 움직일 필요가 있습니다. 자동 재생이 되지 않았다면 플레이 버튼을 클릭해주세요. 작고 자라서 얼마간 큰 소리가 포함되어있으니 볼륨 조절에 유의하십시오.`
...
void Awake()
    {
        ...
        //저는 실제로 작업 중인 프로젝트 내에서 본 스크립트를 작성하기 시작합니다.
...
void four()
    {   
        ...
        print(randomName);
        //한편, 랜덤 함수입니다. 
        //네 가지 선택지는 4차원의 다중우주로 등차하게 존재해있으리라 가정해봅니다.
        //이 글을 쓰고 있는 저는 홀연히 스물 셋이라는 법적 나이를 통과하고 있고, 선택지에는 언뜻 시간성이 느껴지기도 하나
        //친구들, 가족들, 제자들, 선생님들의 어린 시절, 과거, 현재, 미래, 다시 과거로 - 
        //결국 모든 것은 지금 여기에서 소리내고 있습니다.
        ...
        //물론 그라운딩 - 현재 여기에 있는 당신의 신체에 몰입해있는 것은 너무나 긴요한 일임에도 불구하고요.
        //살아있기에, 죽음에 대해 명상할 수도 있는 것이니까요.
