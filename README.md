...
//트라우마 치료 및 예방을 위한 임상적 방법론, '내적가족체계' 및 'EMDR' 기법에서 착안한 플레이 시스템 안에서 
//— 레즈비언 실천, 친족 성폭력, 양자 에너지, 죽음 명상 등에 관련한 인용문이 직조된다.
...
//그렇게도 번역할 수 없는 물건들 — 집을 지키는 사람들(3 Households)의 스테이지들은 특히, 
//선택하거나 선택하지 않은 가족 관계, 심리적 화상, 돌연한 사고 그리고 장례와 추모에 겨냥해있다.
