...
###### *이 글은 작업이 완성되기 약 1~2달 전에 쓰여집니다. PC에 최적화된 아티클로, 스크롤을 상하좌우로 움직일 필요가 있습니다. 이미지-플레이화면은 세부적인 UI 와 레벨디자인에 있어 가변한 프로토타입 단계입니다. 텍스트-코드는 게임의 것과 평행하지만 온전히 동일하지 않습니다.  (energywhoisshe@gmail.com / Cha Yeonså ⓒ 2021)*
