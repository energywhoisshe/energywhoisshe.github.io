...
> `이 글은 작업이 완성되기 약 1~2달 전에 쓰여집니다. PC 기기에 최적화된 아티클로, 스크롤을 상하좌우로 움직일 필요가 있습니다. 자동 재생이 되지 않았다면 플레이 버튼을 클릭해주세요. 작고 자라서 얼마간 큰 소리가 포함되어있으니 볼륨 조절에 유의하십시오.`
...
void Awake()
    {
        //안녕하세요.
        //저는 차연서입니다.
        //스스로 유니티(UNITY) 게임엔진를 배우며 1인으로 아트하우스 게임 개발을 시도해보고 있읍지요.
