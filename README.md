...
void Awake()
    {
        ...
        //저는 실제로 프로젝트 내에서 스크립트를 작성하고 있습니다. 
...
###### *이 글은 작업이 완성되기 약 1~2달 전에 쓰여집니다. PC에 최적화된 아티클로, 스크롤을 상하좌우로 움직일 필요가 있습니다. 이미지-플레이화면은 세부적인 UI 와 레벨디자인에 있어 가변한 프로토타입 단계입니다. 이 문서의 텍스트-코드는 게임 프로젝트를 은유하고 있지만 프로젝트 내의 작동법과 온전히 동일하지는 않습니다. 프리소스, 오프닝, 혹은 때이른 뒷풀이 정도라 생각됩니다.  (energywhoisshe@gmail.com / Cha Yeonså ⓒ 2021)*
