...
void Awake()
    {
        ...
        //저는 실제로 프로젝트 내에서 스크립트를 작성하고 있습니다. 고로 최대한 무효하게 말을 하고 있습니다. 버그가 일어나지 않도록 말입니다.
        ...
        StartCoroutine("sos");  //그리고 여기에는 코루틴이라는 별도의 루프가 적용되어있습니다. 그러니까 다음 6개의 채널은 순차적으로 순환합니다.
    }
```
