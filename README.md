...
void two()
    {
        ...
        //(1) 기획 단계부터 변치 않는 최종적 목표는 플레이어(관객)에게 하여금 회복탄성력을 선물하는 것입니다.
...
void four()
    {   
        ...
        //플레이어 캐릭터 생성기를 설계합니다.
        //그 동안 이 곳에 몸이 없던 당신, 이제는 비로소 플레이어로 생성합니다.
        ...
        // ... 고개를 끄덕거리는 이 자는 H111입니다. 
        // ... 허벅지를 까딱거리는 그 자는 H112입니다.
        // ... 미간을 깜빡거리는 저 자는 H119입니다.
...
void 불가살이()
    {
        ...
        //어린 시절 트라우마를 경험한 성인에게, 내적가족체계에 대한 이해와 EMDR 치료법을 권합니다. [인용] [주 참고서적] [보조 참고서적]
