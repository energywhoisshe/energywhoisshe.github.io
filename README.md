...
void 불가살이()
    {
        ...
        //왜냐하면 저는 한결 무효하게 말을 하고 있지 않습니까? 당신에게 기능하는 많은 게임들 사이로 
        //우리가 오늘 나눈 대화는 잠재태로
        //살아있습니까, 자라나고 있습니까.
...
>`이 글은 작업이 공간에 설치되기 약 1~3달 전에 쓰여집니다. 이미지-플레이화면은 세부적인 UI 와 레벨디자인에 있어 가변한 미완의 단계입니다. 이 문서의 텍스트-코드는 게임 프로젝트를 은유하고 있지만 프로젝트 내의 작동법과 온전히 동일하지는 않습니다. 프리소스, 오프닝, 혹은 때 이른 뒷풀이 정도라 생각됩니다.  (energywhoisshe@gmail.com / Cha Yeonså ⓒ 2021)`
