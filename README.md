...
void four()
    {
        //친족성폭력 특별법, 아동학대 특별법, 차별금지법, 생활동반자법 / 인용문 (내적가족체계 / EMDR 치료)
    }
```
...
###### *이 글은 작업이 완성되기 약 1~2달 전에 쓰여집니다. 스크롤을 상하좌우로 움직일 필요가 있습니다. 플레이화면은 세부적인 UI 와 레벨디자인에 있어 가변한 프로토타입 단계입니다. ( <http://www.instagram.com/oir.ss>  /  energywhoisshe@gmail.com)*
