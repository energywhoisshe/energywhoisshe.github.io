...
void two()
    {
        ...
        //(2) 내적﹒외적 공동체에 대한 인식을 새로이 하여 폭력에 대한 피해-생존자들과 심지어는 가해행위자들까지도 
        //스스로를, 그리고 존재들을
        //모든 살아있고 죽어있는 존재를
        //천애고아로 느끼지 않는 것입니다. 
        ...
        //어쩌면 그것이 타인이나 자신을 학대하는 주된 까닭이 될 것입니다.
        //그러니까 회복탄력성은 스스로에 대한, 그리고 세계에 대한 것이 되겠습니다.
        Debug.Log("한 명의 인물은 세 명으로 이루어진 공동체를 내재하고 세 명으로 이루어진 공동체의 총합은 한 명의 인물이 된다.");
        Debug.Log("이러한 3인 가족 구조는 프렉탈 네트워크의 형태로 확장한다."); //는 것은 게임의 내용이지만
        //우리가 모든 것과 연결되어 있다는 것은 단호하게도 사실이 아닙니까?
